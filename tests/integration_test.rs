...
fn process_taxonomy() {
    ...
    assert_eq!(acc2tax::get_taxon("X59856.2".to_string()), 
                9913,
                "Get taxon error");

    assert_eq!(acc2tax::get_complete_taxonomy(9913), 
                [9913, 9903, 27592, 9895, 35500, 9845, 91561, 314145, 1437010, 9347, 32525, 40674, 32524, 32523, 1338369, 8287, 117571, 117570, 7776, 7742, 89593, 7711, 33511, 33213, 6072, 33208, 33154, 2759, 131567, 1], 
